...
.controller('UseropCtrl', function ($location , userservice) {
  ...
  this.userLogin = function(name , pwd , type){
    if(name === "test" && pwd === "password"){
      ...
      userservice.storeInfo({"userid" : "test" , "name" : "Zairza" , "contact" : "9574647" , "address" : "101 B , Keshari Enclave" , "email" : "info@zairza.in" , "id" : "100000000000" , "userType" : "Organization"})
